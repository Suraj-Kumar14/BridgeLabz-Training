...
public class EmailServiceImpl implements EmailService {
	...
	public void sendRegistrationOtp(String to, String otp) {
		...
		String subject = "Fundoo Notes - Email Verification OTP";
	...
	public void sendPasswordResetOtp(String to, String otp) {
		...
		String subject = "Fundoo Notes - Password Reset OTP";
	...
	public void sendPasswordResetSuccess(String to) {
		...
		String subject = "Fundoo Notes - Password Reset Successful";
	...
	@Override
	public void sendReminderEmail(String to, String noteTitle) {
